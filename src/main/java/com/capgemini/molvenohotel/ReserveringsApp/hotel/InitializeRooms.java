...
public class InitializeRooms {
    ...
    public InitializeRooms() {
        ...
        rooms.add(new Room("101", "Single", 999, 1, 0, 0, 1,1, 0, true, notDisabledFriendly, null));
        ...
        rooms.add(new Room("210", "Double", 999, 1, 0, 0, 2,2, 0, true, disabledFriendly, null));
        rooms.add(new Room("211", "Double", 999, 1, 0, 0, 2,2, 0, true, notDisabledFriendly, null));
        rooms.add(new Room("212", "Double", 999, 1, 0, 0, 2,2, 0, true, notDisabledFriendly, null));
        rooms.add(new Room("213", "Double", 999, 1, 0, 0, 2,2, 0, true, notDisabledFriendly, null));
        rooms.add(new Room("214", "Double", 999, 1, 0, 0, 3,2, 1, true, notDisabledFriendly, null));
        rooms.add(new Room("215", "Double", 999, 1, 0, 0, 3,2, 1, true, notDisabledFriendly, null));
        rooms.add(new Room("216", "Double", 999, 1, 0, 0, 4,2, 2, true, notDisabledFriendly, null));
        rooms.add(new Room("217", "Double", 999, 1, 0, 0, 6,4, 2, true, notDisabledFriendly, null));
        rooms.add(new Room("218", "2x Double", 999, 1, 0, 1, 4,2, 2, true, notDisabledFriendly, null));
        rooms.add(new Room("219", "Double", 999, 1, 0, 1, 6,4, 2, true, notDisabledFriendly, null));
